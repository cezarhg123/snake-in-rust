        ...
        match input {
            Input::Up => {
                if self.crnt_direction != Direction::South {
                    ...
                    self.movements.push((self.tail.0, self.tail.1, Direction::North));
                }
                *input = Input::NoInput;
            },
            Input::Down => {
                if self.crnt_direction != Direction::North {
                    ...
                    self.movements.push((self.tail.0, self.tail.1, Direction::South));
                }
                *input = Input::NoInput;
            },
            Input::Left => {
                if self.crnt_direction != Direction::East {
                    ...
                    self.movements.push((self.tail.0, self.tail.1, Direction::West));
                }
                *input = Input::NoInput;
            },
            Input::Right => {
                if self.crnt_direction != Direction::West {
                    ...
                    self.movements.push((self.tail.0, self.tail.1, Direction::East));
                }
                *input = Input::NoInput;
            },
            _ => {}
